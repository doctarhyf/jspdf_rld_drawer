...
function drawLogo2() {
  ...
  /* let origi_font = doc.getFont();
  console.table(origi_font);
  
  doc.setFont("DroidSansFallback");

  doc.setFont(origi_font.fontName);
  let line = "GCK";
  let line_size = doc.getTextWidth(line) + 15;
  doc.text(15, 30, line);

  doc.setFont("DroidSansFallback");
  doc.text(line_size, 30, "公司水泥线水泥翻译名单"); */
}
